...
#This is the start of the stuff I added
...
#printf "Mod + d for opening programs"
#printf "Shift+Mod+q for closing windows"
#printf "shift+mod+e to exit i3"
#printf "Mod + R to restart i3 \n\n"

#printf "Mod + arrows/jkl; for changing windows"
#printf -n "Mod + f for fullscreen \n\n"

#printf "mod +s stacked layout"
#printf "mod + a focus parrent" 


export EDITOR=nvim

# exec bash to get the bash shell. exec fish to get the fish shell
#exec fish
