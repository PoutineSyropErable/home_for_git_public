...
canvas_width = 2*(eDP_box_width + HDMI_box_width + 40)  # Including padding
canvas_height = 2*(eDP_box_height + HDMI_box_height) + 40  # Including padding
...
def move_hdmi(event):
    ...
    if new_x < eDP_x - HDMI_box_width:
        new_x = eDP_x - HDMI_box_width
    elif new_x > eDP_x + eDP_box_width:
        new_x = eDP_x + eDP_box_width

    # Check vertical alignment
    if new_y < eDP_y - HDMI_box_height:
        new_y = eDP_y - HDMI_box_height
    elif new_y > eDP_y + eDP_box_height:
